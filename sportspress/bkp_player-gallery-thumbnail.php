...
//echo '<pre>';
//print_r(get_post_meta( $id, 'sp_statistics' ));
...
if ( has_post_thumbnail( $id ) )
	...
	$thumbnail = '<img width="250" height="250" src="//www.gravatar.com/avatar/?s=150&d=mm&f=y" class="attachment-thumbnail wp-post-image">';

echo "<{$itemtag} class='gallery-item col-md-3'>";
echo "
