 ...
 */
function skyre_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Skyre default saturation level.
	 *
	 * @since Skyre 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'skyre_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.skyre-front-page) .entry-title,
...
.colors-custom .skyre-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.skyre-front-page .panel-content .recent-posts article,
...
.colors-custom.skyre-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Skyre custom colors CSS.
	 *
	 * @since Skyre 1.0
	 *
	 ...
	 */
	return apply_filters( 'skyre_custom_colors_css', $css, $hue, $saturation );
}
