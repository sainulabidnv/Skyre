...
?>
<div class="post-image col-lg-<?php echo $entry_count; ?><?php if ( is_single() ) { echo ' skyre-single-post-item';  } else { echo ' skyre-post-item';} ?>" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<article>
    <?php
